function SpecialBetService( $http, $cacheFactory, ErrorService, tournamentID ) {
...
SpecialBetService.$inject = ['$http', '$cacheFactory', 'ErrorService', 'tournamentID'];

module.exports = SpecialBetService;
