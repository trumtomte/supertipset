...
function GameDirective( BetService, ngNotify, ngDialog, userID, calculator ) {
...
GameDirective.$inject = ['BetService', 'ngNotify', 'ngDialog', 'userID', 'calculator'];
